...
// alpha3ToAlpha2 maps ISO 3166-1 alpha-3 codes to alpha-2. Pool metadata,
// manifests and operator input may use either form; selection compares
// canonical alpha-2 only.
...
// NormalizeCountryCode canonicalizes a country code to uppercase ISO 3166-1
// alpha-2. Alpha-3 input maps through the ISO table; anything else passes
// through uppercased so selection never mismatches on case alone.
